...
test("eslint complexity measurement remains a non-blocking warning with the agreed threshold", () => {
  ...
  assert.doesNotMatch(packageSource, /eslint-plugin-(?:sonarjs|complexity|codeclimate)/);
});
