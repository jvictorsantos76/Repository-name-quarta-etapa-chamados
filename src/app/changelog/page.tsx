...
const versoes = [
  {
    ...
    data: "11/05/2026",
    alteracoes: [
      "Login, callback OAuth e Aguardando Aprovação passam a consultar um único resolvedor server-side para reconciliar Auth confirmado, solicitacoes_acesso, perfis e cookies antes de decidir o destino do usuário.",
      "Confirmação de e-mail e login com senha passam a liberar automaticamente acesso temporário de 72 horas úteis como solicitante, sem aprovação admin, quando a solicitação estiver válida.",
      "Cadastro de Usuário v0.3.8 passa a vincular cliente/unidade reais quando identificados com segurança e usa fila de triagem quando o cadastro não permite vinculação confiável.",
      "Novo Chamado v0.2.2 e a home passam a suportar acompanhamento dos próprios chamados pelo usuário temporário, sem expor dashboard e navegação administrativa.",
    ...
    correcoes: [
      "Corrige usuário com Auth confirmado e solicitação presa em pendente_confirmacao_email, reconciliando automaticamente o acesso temporário no servidor.",
      "Corrige casos em que o usuário autenticava com sucesso, mas continuava preso em Aguardando Aprovação por ausência de perfil temporário ou vínculo inicial.",
      "Corrige o fallback de cliente/unidade para acesso temporário sem liberar escolha arbitrária de dados operacionais reais.",
