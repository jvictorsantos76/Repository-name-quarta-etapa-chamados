...
- Versao operacional visivel: `v0.9.72`
- Publicada em: `2026-07-11`
- Versao tecnica do pacote: `0.7.12`
...
| Dashboard | `v0.1.0` |
| Login | `v0.2.2` |
| Cadastro de usuario | `v0.4.1` |
| Solicitacoes de acesso | `v0.3.4` |
| Perfil de usuario | `v0.1.4` |
| Conta | `v0.1.1` |
| Conta / Perfil | `v0.2.0` |
| Conta / Aparencia | `v0.1.0` |
| Conta / Permissoes | `v0.1.2` |
| Novo chamado | `v0.3.0` |
| Status de chamados | `v1.0.1` |
| Status de artigos | `v1.0.1` |
| Tipos de chamado | `v1.0.1` |
| Tipos de artigo | `v1.0.1` |
| Origens de chamado | `v1.0.1` |
| Grupos de atendimento | `v1.0.1` |
| SLAs | `v1.0.0` |
| Calendarios de SLA / Horarios de funcionamento | `v1.0.1` |
| Organizacoes | `v1.1.2` |
| Clientes / Parceiros | `v1.1.46` |
| Contratos | `v1.0.8` |
| Base de conhecimento | `v1.3.4` |
| Documentos legais | `v0.7.0` |
